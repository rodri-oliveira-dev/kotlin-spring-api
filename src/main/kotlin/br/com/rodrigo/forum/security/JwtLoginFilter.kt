package br.com.rodrigo.forum.security

import br.com.rodrigo.forum.config.JwtUtil
import br.com.rodrigo.forum.model.Credentials
...
class JwtLoginFilter(private val authManager: AuthenticationManager, private val jwtUtil: JwtUtil) :
    ...
    override fun successfulAuthentication(
        ...
        val token = jwtUtil.generateToken(user.username, user.authorities, host)
